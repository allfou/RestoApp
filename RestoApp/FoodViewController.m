...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath*)indexPath {
    ...
    [[NSUserDefaults standardUserDefaults] setValue:[tableView cellForRowAtIndexPath:indexPath].textLabel.text forKey:@"foodType"];
    
    // Refresh Restaurant list with new food type
    [[NSNotificationCenter defaultCenter] postNotificationName:@"reloadRestaurantListMessageEvent" object:self.selectedFood];
...
- (void)tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell*)cell forRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.selectedFood isEqualToString:cell.textLabel.text]) {
